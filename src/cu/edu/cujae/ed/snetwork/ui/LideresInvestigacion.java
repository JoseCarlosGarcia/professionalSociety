...
public class LideresInvestigacion extends javax.swing.JDialog
{
     ...
     * @param fileManager
     */
    public LideresInvestigacion(java.awt.Frame parent, boolean modal, List<Person> persons, FileManager fileManager)
    {
        super(parent, modal);
        initComponents();
    ...
    {//GEN-HEADEREND:event_jButton2ActionPerformed
        try
        {
            SaveTXT.saveResearchLeaders(persons, fileManager);
            JOptionPane.showMessageDialog(this, "Se ha guardado con éxito el documento", "Completado", HEIGHT, null);
        }
        catch (IOException ex)
        {
            Logger.getLogger(LideresInvestigacion.class.getName()).log(Level.SEVERE, null, ex);
        }
